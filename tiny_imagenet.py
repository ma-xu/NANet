...
parser.add_argument('-d', '--data', default='/home/g1007540910/DATA/TinyImageNet/', type=str)
...
def main():
    ...
    if(args.arch == "inception_v3"):
        crop_size = 64
        val_size = 64 # I chose this value arbitrarily, we can adjust.
    else:
        crop_size = 64
        val_size = 64
