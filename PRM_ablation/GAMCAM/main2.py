...
@click.option("-a", "--arch", default="se_resnet50", type=click.Choice(model_names), required=True)
@click.option("-c", "--checkpoint", default="/home/g1007540910/RDA_imagenet_GCP/checkpoints/imagenet/", type=str, required=True)
...
def demo1(image_paths, target_layer, arch, topk, output_dir, cuda,checkpoint,distribute):
    """
