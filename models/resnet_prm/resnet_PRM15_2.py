...
__all__ = ['prm15_2_resnet18','prm15_2_resnet34','prm15_2_resnet50','prm15_2_resnet101','prm15_2_resnet152']
...
class PRMLayer(nn.Module):
    ...
    def get_similarity(self,query, key_value, mode='dotproduct'):
        if mode == 'dotproduct':
            ...
            similarity = similarity/math.sqrt(query.shape[1])
        elif mode == 'l1norm':
...
def prm15_2_resnet18(pretrained=False, **kwargs):
...
def prm15_2_resnet34(pretrained=False, **kwargs):
...
def prm15_2_resnet50(pretrained=False, **kwargs):
...
def prm15_2_resnet101(pretrained=False, **kwargs):
...
def prm15_2_resnet152(pretrained=False, **kwargs):
...
def demo():
    ...
    for i in range(1):
        net = prm15_2_resnet50(num_classes=1000)
...
def demo2():
    st = time.perf_counter()
    for i in range(1):
        net = prm15_2_resnet50(num_classes=1000).cuda()
