...
__all__ = ['prm7_resnet18','prm7_resnet34','prm7_resnet50','prm7_resnet101','prm7_resnet152']
...
def prm7_resnet18(pretrained=False, **kwargs):
...
def prm7_resnet34(pretrained=False, **kwargs):
...
def prm7_resnet50(pretrained=False, **kwargs):
...
def prm7_resnet101(pretrained=False, **kwargs):
...
def prm7_resnet152(pretrained=False, **kwargs):
...
def demo():
    ...
    for i in range(1):
        net = prm7_resnet50(num_classes=1000)
...
def demo2():
    st = time.perf_counter()
    for i in range(1):
        net = prm7_resnet50(num_classes=1000).cuda()
