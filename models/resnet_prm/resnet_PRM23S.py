...
__all__ = ['prm23_resnet18_g1','prm23_resnet18_g4','prm23_resnet18_g16','prm23_resnet18_g32','prm23_resnet18_g128',
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None,groups=64):
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,groups=64):
    ...
    def _make_layer(self, block, planes, blocks, stride=1,groups=64):
        downsample = None
...
def prm23_resnet18_g1(pretrained=False, groups=1, **kwargs):
...
def prm23_resnet18_g16(pretrained=False, groups=16, **kwargs):
    """Constructs a ResNet-18 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
...
def prm23_resnet50_g1(pretrained=False,groups=1, **kwargs):
    """Constructs a ResNet-50 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(Bottleneck, [3, 4, 6, 3], groups=groups,**kwargs)
    return model
...
def prm23_resnet50_g4(pretrained=False,groups=4, **kwargs):
    """Constructs a ResNet-50 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
...
def prm23_resnet50_g16(pretrained=False,groups=16, **kwargs):
    """Constructs a ResNet-50 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
...
def prm23_resnet50_g32(pretrained=False,groups=32, **kwargs):
    """Constructs a ResNet-50 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
...
def prm23_resnet50_g128(pretrained=False,groups=128, **kwargs):
    """Constructs a ResNet-50 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
...
def demo():
    ...
    for i in range(1):
        net = prm23_resnet50_g128(num_classes=1000)
...
def demo2():
    st = time.perf_counter()
    for i in range(1):
        net = prm23_resnet50_g1(num_classes=1000).cuda()
