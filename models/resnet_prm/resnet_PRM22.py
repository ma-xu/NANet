...
__all__ = ['prm22_resnet18','prm22_resnet34','prm22_resnet50','prm22_resnet101','prm22_resnet152']
...
def prm22_resnet18(pretrained=False, **kwargs):
...
def prm22_resnet34(pretrained=False, **kwargs):
...
def prm22_resnet50(pretrained=False, **kwargs):
...
def prm22_resnet101(pretrained=False, **kwargs):
...
def prm22_resnet152(pretrained=False, **kwargs):
...
def demo():
    ...
    for i in range(1):
        net = prm22_resnet50(num_classes=1000)
...
def demo2():
    st = time.perf_counter()
    for i in range(1):
        net = prm22_resnet50(num_classes=1000).cuda()
