...
"""
Normalize(similarity) + position

"""

__all__ = ['prm6_resnet18','prm6_resnet34','prm6_resnet50','prm6_resnet101','prm6_resnet152']
...
def prm6_resnet18(pretrained=False, **kwargs):
...
def prm6_resnet34(pretrained=False, **kwargs):
...
def prm6_resnet50(pretrained=False, **kwargs):
...
def prm6_resnet101(pretrained=False, **kwargs):
...
def prm6_resnet152(pretrained=False, **kwargs):
...
def demo():
    ...
    for i in range(1):
        net = prm6_resnet50(num_classes=1000)
...
def demo2():
    st = time.perf_counter()
    for i in range(1):
        net = prm6_resnet50(num_classes=1000).cuda()
