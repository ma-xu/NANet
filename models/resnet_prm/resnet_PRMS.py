...
__all__ = ['prms_8x8_l1norm_resnet50']
...
def prms_16x1_l1norm_resnet50(pretrained=False, **kwargs):
...
def prms_8x8_l1norm_resnet50(pretrained=False, **kwargs):
    """Constructs a ResNet-50 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
...
def demo():
    ...
    for i in range(1):
        net = prms_8x8_l1norm_resnet50(num_classes=1000)
...
def demo2():
    st = time.perf_counter()
    for i in range(1):
        net = prms_8x8_l1norm_resnet50(num_classes=1000).cuda()
