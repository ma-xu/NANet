...
__all__ = ['prm10_resnet18','prm10_resnet34','prm10_resnet50','prm10_resnet101','prm10_resnet152']
...
def prm10_resnet18(pretrained=False, **kwargs):
...
def prm10_resnet34(pretrained=False, **kwargs):
...
def prm10_resnet50(pretrained=False, **kwargs):
...
def prm10_resnet101(pretrained=False, **kwargs):
...
def prm10_resnet152(pretrained=False, **kwargs):
...
def demo():
    ...
    for i in range(1):
        net = prm10_resnet50(num_classes=1000)
...
def demo2():
    st = time.perf_counter()
    for i in range(1):
        net = prm10_resnet50(num_classes=1000).cuda()
