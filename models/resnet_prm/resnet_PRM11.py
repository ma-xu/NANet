...
__all__ = ['prm11_resnet18','prm11_resnet34','prm11_resnet50','prm11_resnet101','prm11_resnet152']

"""
group is the number of selected points.
"""
class PRMLayer(nn.Module):
    def __init__(self, channel,reduction=2,groups=64,mode='l1norm'):
...
def prm11_resnet18(pretrained=False, **kwargs):
...
def prm11_resnet34(pretrained=False, **kwargs):
...
def prm11_resnet50(pretrained=False, **kwargs):
...
def prm11_resnet101(pretrained=False, **kwargs):
...
def prm11_resnet152(pretrained=False, **kwargs):
...
def demo():
    ...
    for i in range(1):
        net = prm11_resnet50(num_classes=1000)
...
def demo2():
    st = time.perf_counter()
    for i in range(1):
        net = prm11_resnet50(num_classes=1000).cuda()
