...
__all__ = ['prm19_resnet18','prm19_resnet34','prm19_resnet50','prm19_resnet101','prm19_resnet152']
...
def prm19_resnet18(pretrained=False, **kwargs):
...
def prm19_resnet34(pretrained=False, **kwargs):
...
def prm19_resnet50(pretrained=False, **kwargs):
...
def prm19_resnet101(pretrained=False, **kwargs):
...
def prm19_resnet152(pretrained=False, **kwargs):
...
def demo():
    ...
    for i in range(1):
        net = prm19_resnet50(num_classes=1000)
...
def demo2():
    st = time.perf_counter()
    for i in range(1):
        net = prm19_resnet50(num_classes=1000).cuda()
