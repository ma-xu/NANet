...
__all__ = ['prm8_resnet18','prm8_resnet34','prm8_resnet50','prm8_resnet101','prm8_resnet152']
...
def prm8_resnet18(pretrained=False, **kwargs):
...
def prm8_resnet34(pretrained=False, **kwargs):
...
def prm8_resnet50(pretrained=False, **kwargs):
...
def prm8_resnet101(pretrained=False, **kwargs):
...
def prm8_resnet152(pretrained=False, **kwargs):
...
def demo():
    ...
    for i in range(1):
        net = prm8_resnet50(num_classes=1000)
...
def demo2():
    st = time.perf_counter()
    for i in range(1):
        net = prm8_resnet50(num_classes=1000).cuda()
