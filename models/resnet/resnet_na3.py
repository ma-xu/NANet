...
def na3_resnet18(pretrained=False, **kwargs):
...
def na3_resnet34(pretrained=False, **kwargs):
...
def na3_resnet50(pretrained=False, **kwargs):
...
def na3_resnet101(pretrained=False, **kwargs):
...
def na3_resnet152(pretrained=False, **kwargs):
...
def demo():
    net = na3_resnet50(num_classes=1000)
