...
__all__ = ['na_resnet18', 'na_resnet34', 'na_resnet50', 'na_resnet101', 'na_resnet152']
...
def na_resnet18(pretrained=False, **kwargs):
...
def na_resnet34(pretrained=False, **kwargs):
...
def na_resnet50(pretrained=False, **kwargs):
...
def na_resnet101(pretrained=False, **kwargs):
...
def na_resnet152(pretrained=False, **kwargs):
...
def demo():
    net = na_resnet50(num_classes=1000)
