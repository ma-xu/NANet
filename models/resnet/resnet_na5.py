...
def na5_resnet18(pretrained=False, **kwargs):
...
def na5_resnet34(pretrained=False, **kwargs):
...
def na5_resnet50(pretrained=False, **kwargs):
...
def na5_resnet101(pretrained=False, **kwargs):
...
def na5_resnet152(pretrained=False, **kwargs):
...
def demo():
    net = na5_resnet50(num_classes=1000)
