...
__all__ = ['na2_resnet18', 'na2_resnet34', 'na2_resnet50', 'na2_resnet101', 'na2_resnet152']
...
def na2_resnet18(pretrained=False, **kwargs):
...
def na2_resnet34(pretrained=False, **kwargs):
...
def na2_resnet50(pretrained=False, **kwargs):
...
def na2_resnet101(pretrained=False, **kwargs):
...
def na2_resnet152(pretrained=False, **kwargs):
...
def demo():
    net = na2_resnet50(num_classes=1000)
