"""
For validation: We train models for 55 eopch, and lr/10 every 15 epoch
...
def main():
    ...
    pipe = HybridValPipe(batch_size=32, num_threads=8, device_id=args.local_rank, data_dir=valdir, crop=crop_size, size=val_size)
    pipe.build()
